...
public class ImportController extends Controller {
    ...
    public void dataImport(){
        ...
        importService.dataImportTaskSetting(taskId,warmTime,stStartTime,fStartTime,fEndTime,evaporationValue,isAutoForecast,isConsiderFutureRainfall,isConsiderAddRainfall);
