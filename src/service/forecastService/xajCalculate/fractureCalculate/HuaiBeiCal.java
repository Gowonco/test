...
public class HuaiBeiCal extends DchyubasH {
    ...
    public HuaiBeiCal(String dyly, int longtime,int longtimePre, float[] para1, float[][] para2,float[] evap, float[] qobs, float[][] zdylp, float[][] state,String[]timeSeries,int realTimeIndex,Map<String,Object>subParameter) throws Exception {
    ...
    public Map<String,Object> charactHuaiBei(){
